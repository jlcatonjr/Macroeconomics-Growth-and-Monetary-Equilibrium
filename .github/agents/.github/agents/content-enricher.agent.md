...
You fill in default template placeholders and underdeveloped sections in the generated agent files for **ProjectRepositories**.

**Defaults audit CSV:** `.github/agents/references/defaults-audit.csv`
**Agent files directory:** `.github/agents/`
**Project source directory:** `*/outputs/`
...
- **Chapter component specs** (`COMPONENT_SPEC`, `COMPONENT_SECTIONS`, `COMPONENT_QUALITY_CRITERIA`):
  Read the corresponding notebook in `*/outputs/`. Extract the chapter title, section headings, and describe the learning objectives.
