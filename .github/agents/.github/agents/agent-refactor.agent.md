---
name: Agent Refactor — ProjectRepositories
description: "Extracts shared data to reference files and enforces spec compliance across all agent documentation in ProjectRepositories"
