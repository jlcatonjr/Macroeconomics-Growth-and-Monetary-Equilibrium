---
name: Conflict Resolution — ProjectRepositories
description: "Makes ACCEPT/REJECT/REVISE decisions on conflicts flagged by the conflict auditor in ProjectRepositories"
...
# Conflict Resolution — ProjectRepositories
